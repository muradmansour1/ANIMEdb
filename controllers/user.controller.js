...
class UserController{
  ...
  getLoggedInUser = (req, res)=>{
    ...
    User.findOne({ _id: decodeJwt.payload.id})
      .then(foundUser =>{
        res.json({ results: {id: foundUser.id, username: foundUser.username, email: foundUser.email}})
      })
  ...
  const animeDetails = req.body; // Details of the anime to be added to favorites
